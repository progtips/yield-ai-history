    ...
    paths: {
      ...
      '/api/aptos/walletBalance': {
        get: {
          ...
          description:
            'Returns all fungible token balances with non-zero amount for the specified address',
          parameters: [
            {
              name: 'address',
              in: 'query',
      ...
      '/api/aptos/walletBalanceWithPrices': {
        get: {
          ...
          description:
            'Returns all fungible token balances with price information for the specified address',
          parameters: [
            {
              name: 'address',
              in: 'query',
      ...
      '/api/aptos/portfolio': {
        get: {
          ...
          description:
            'Returns complete portfolio information including wallet tokens and DeFi protocol positions',
          parameters: [
            {
              name: 'address',
              in: 'query',
                      ...
                      totals: {
                        ...
                        properties: {
                          ...
                          protocolsValue: {
                            ...
                            example: 5678.9,
                            description:
                              'Total value of DeFi protocol positions',
                          },
                          totalValue: {
                            type: 'number',
                            example: 6913.46,
      ...
      '/api/protocols/hyperion/pools/{poolId}': {
        get: {
          ...
          description:
            'Returns detailed information about a specific Hyperion pool by its ID',
          parameters: [
            {
              name: 'poolId',
              in: 'path',
              ...
              description: 'Pool ID',
              example:
                '0x76d9ab75b28e5e9be6268c88a3d223237d23467a3dd5c8703a69f1fbeda23478',
            },
          ],
          responses: {
            '200': {
      ...
      '/api/protocols/hyperion/pools/by-tokens': {
        get: {
          ...
          description:
            'Returns a specific Hyperion pool by token pair and fee tier',
          parameters: [
            {
              name: 'token1',
              in: 'query',
      ...
      '/api/protocols/hyperion/userPositions': {
        get: {
          ...
          description:
            'Returns user positions in Hyperion protocol for the specified address',
          parameters: [
            {
              name: 'address',
              in: 'query',
      ...
      '/api/protocols/echelon/userPositions': {
        get: {
          ...
          description:
            'Returns user positions in Echelon lending protocol for the specified address',
          parameters: [
            {
              name: 'address',
              in: 'query',
      ...
      '/api/protocols/aries/userPositions': {
        get: {
          ...
          description:
            'Returns user positions in Aries lending protocol for the specified address',
          parameters: [
            {
              name: 'address',
              in: 'query',
      ...
      '/api/protocols/joule/userPositions': {
        get: {
          ...
          description:
            'Returns user positions in Joule lending protocol for the specified address',
          parameters: [
            {
              name: 'address',
              in: 'query',
      ...
      '/api/aptos/pools': {
        get: {
          ...
          description:
            'Returns information about all pools from Aptos protocols',
          responses: {
            '200': {
              description: 'Successful response',
              content: {
