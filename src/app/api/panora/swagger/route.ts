    ...
    paths: {
      ...
      '/api/panora/tokenPrices': {
        get: {
          ...
          description:
            'Returns token prices from Panora API. You can get prices for all tokens or specific tokens by their addresses.',
          parameters: [
            {
              name: 'tokenAddress',
              in: 'query',
              ...
              schema: {
                type: 'string',
                example:
                  '0xbae207659db88bea0cbead6da0ed00aac12edcdda169e591cd41c94180b46f3b,0x1::aptos_coin::AptosCoin',
              },
            },
            {
              name: 'chainId',
