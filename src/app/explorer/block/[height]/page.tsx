...
export default function BlockPage({ params }: BlockPageProps) {
  ...
  const loadBlockData = async () => {
    try {
      ...
      setError(
        error instanceof Error ? error.message : 'Failed to load block data'
      );
    } finally {
      setIsLoading(false);
    }
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>Block creation time</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>Starting version</p>
          </CardContent>
        </Card>
