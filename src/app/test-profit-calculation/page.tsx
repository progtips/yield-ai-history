  ...
  const handleRefreshHistory = () => {
    ...
    const fetchRealTransactions = async (address: string) => {
      try {
        ...
        console.log(`Fetched ${data.length} transactions for profit calculation`);
        ...
        const transformedTransactions = data.map((tx: any, index: number) => {
          ...
          const { amount: extractedAmount, token: extractedToken } = extractTransactionAmount(tx, String(tx.sender || 'Unknown'));
        ...
        console.log(`Transformed ${transformedTransactions.length} transactions for profit calculation`);
    ...
    fetchRealTransactions(walletAddress)
      .then((realTransactions) => {
        console.log(`Fetched ${realTransactions.length} real transactions for profit calculation`);
