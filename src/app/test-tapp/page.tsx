  ...
  const fetchTappPools = async () => {
    ...
    try {
      const response = await fetch(
        `/api/protocols/tapp/pools?chain=aptos&page=${pagination.page}&limit=${pagination.limit}`
      );
      ...
      if (data.success && Array.isArray(data.data)) {
        ...
        setPagination(
          data.pagination || { page: 1, limit: 50, total: data.data.length }
        );
      } else {
    ...
    <div className='container mx-auto p-6 space-y-6'>
      <div>
        ...
        <p className='text-muted-foreground'>
          Test Tapp Exchange pools integration and see the transformation from
          raw data
        </p>
      </div>
        ...
        <CardContent>
          <div className='grid grid-cols-2 md:grid-cols-6 gap-4'>
            ...
            <div className='text-center'>
              <div className='text-2xl font-bold'>
                {filteredPools.length > 0
                  ? formatPercentage(
                      filteredPools.reduce((sum, pool) => sum + pool.apr, 0) /
            ...
            <div className='text-center'>
              <div className='text-2xl font-bold'>
                {formatCurrency(
                  filteredPools.reduce((sum, pool) => sum + pool.tvl, 0)
                )}
              </div>
              ...
              <div className='text-2xl font-bold'>
                {formatCurrency(
                  filteredPools.reduce(
                    (sum, pool) => sum + (pool.volumeData?.volume24h || 0),
                    0
                  )
                )}
              </div>
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <div className='flex items-center gap-4'>
                      ...
                      <div className='text-right'>
                        ...
                        <div className='font-semibold'>
                          {formatCurrency(pool.volumeData?.volume24h || 0)}
                        </div>
                      </div>
                      ...
                      <div className='text-right'>
                        ...
                        <div className='font-semibold'>
                          {formatPercentage(pool.fee_tier)}
                        </div>
                      </div>
