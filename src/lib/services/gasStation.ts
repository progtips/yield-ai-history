...
export class GasStationService {
  ...
  private initializeGasStationClient() {
    try {
      ...
      console.log(
        'NEXT_PUBLIC_APTOS_GAS_STATION_KEY:',
        process.env.NEXT_PUBLIC_APTOS_GAS_STATION_KEY
      );
      console.log(
      ...
      if (!apiKey) {
        console.warn(
          'NEXT_PUBLIC_APTOS_GAS_STATION_KEY not found, gas station will not be available'
        );
        return;
      }
