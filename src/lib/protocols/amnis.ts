...
export class AmnisProtocol implements BaseProtocol {
  ...
  async buildDeposit(
    ...
    console.log('Amnis buildDeposit called with:', {
      amountOctas,
      token,
      walletAddress,
    });
    ...
    if (token === '0x1::aptos_coin::AptosCoin') {
      ...
      console.log(
        'Arguments types:',
        payload.arguments.map(arg => ({ value: arg, type: typeof arg }))
      );
    ...
    // Check if it's amAPT token - use stake_entry function
      ...
      return {
        type: 'entry_function_payload' as const,
        function:
          '0x111ae3e5bc816a5e63c2da97d0aa3886519e0cd5e4b046659fa35796bd11542a::stake::stake',
  ...
  async buildWithdraw(
    ...
    return {
      type: 'entry_function_payload' as const,
      function:
        '0x111ae3e5bc816a5e63c2da97d0aa3886519e0cd5e4b046659fa35796bd11542a::stake::unstake',
      type_arguments: [token],
      arguments: [amountOctas.toString()],
    };
  }
  ...
  async buildClaimRewards(
    ...
    return {
      type: 'entry_function_payload' as const,
      function:
        '0x111ae3e5bc816a5e63c2da97d0aa3886519e0cd5e4b046659fa35796bd11542a::stake::claim_rewards',
      type_arguments: [],
