...
function getProtocolFromTransaction(tx: any): string {
  ...
  if (functionName.includes('hyperion') || functionName.includes('router_v3')) {
    ...
    functionName.includes('scripts::supply')
  ) {
    return 'Echelon';
  } else if (
    functionName.includes('amnis') ||
    functionName.includes('router::deposit_and_stake')
  ) {
    return 'Amnis';
  } else if (
    functionName.includes('joule') ||
    functionName.includes('joule::')
  ) {
    return 'Joule';
  } else if (
    functionName.includes('aries') ||
    functionName.includes('aries::')
  ) {
    return 'Aries';
    ...
    functionName.includes('panora') ||
    functionName.includes('panora_swap')
  ) {
    return 'Panora';
...
export function createTransactionDescription(tx: any): TransactionDescription {
  ...
  if (
    functionName.includes('create_liquidity') ||
    functionName.includes('add_liquidity')
  ) {
    action = 'Add Liquidity';
  } else if (
    functionName.includes('remove_liquidity') ||
    functionName.includes('withdraw_liquidity')
  ) {
    ...
    functionName.includes('undelegate')
  ) {
    action = 'Unstake';
