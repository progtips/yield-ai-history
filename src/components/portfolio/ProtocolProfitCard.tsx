      ...
      <CardContent className='space-y-4'>
        ...
        <div className='grid grid-cols-2 gap-4'>
          <div className='space-y-2'>
            <div className='flex items-center gap-2 text-sm'>
              ...
              <span className='font-medium'>
                {formatProfitValue(profitData.totalDeposits)}
              </span>
            </div>
            ...
            <div className='flex items-center gap-2 text-sm'>
              ...
              <span className='font-medium'>
                {formatProfitValue(profitData.totalWithdrawals)}
              </span>
            </div>
            ...
            <div className='flex items-center gap-2 text-sm'>
              ...
              <span className='font-medium'>
                {formatProfitValue(profitData.totalClaims)}
              </span>
            </div>
          </div>
          ...
          <div className='space-y-2'>
            <div className='flex items-center gap-2 text-sm'>
              ...
              <span className='font-medium'>
                {formatProfitValue(profitData.totalSwaps)}
              </span>
            </div>
            ...
            <div className='flex items-center gap-2 text-sm'>
              ...
              <span className='font-medium'>
                {formatPercentage(profitData.apy)}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className='pt-3 border-t border-gray-200'>
          <div className='grid grid-cols-2 gap-4 text-xs text-gray-600'>
            <div>
              ...
              <div>
                {new Date(profitData.firstTransactionDate).toLocaleDateString(
                  'ru-RU'
                )}
              </div>
            </div>
            <div>
              ...
              <div>
                {new Date(profitData.lastTransactionDate).toLocaleDateString(
                  'ru-RU'
                )}
              </div>
            </div>
          ...
          <div className='mt-2 text-xs text-gray-600'>
            <span className='font-medium'>Активных дней:</span>{' '}
            {profitData.activeDays}
          </div>
        </div>
        ...
        <div className='pt-2 border-t border-gray-200'>
          <div className='text-xs text-gray-600'>
            <span className='font-medium'>Средняя транзакция:</span>{' '}
            {formatProfitValue(profitData.averageTransactionValue)}
          </div>
        </div>
      </CardContent>
    </Card>
