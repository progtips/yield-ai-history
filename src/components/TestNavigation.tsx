    ...
    <div className='container mx-auto p-6'>
      ...
      <div className='mt-8 p-4 bg-muted rounded-lg'>
        ...
        <p className='text-sm text-muted-foreground'>
          These pages are for development and testing purposes. They provide
          interfaces to test various integrations, APIs, and features before
          they are integrated into the main application.
        </p>
      </div>
    </div>
  );
