        ...
        <div className='flex items-center gap-2'>
          <div className='flex flex-col items-center'>
            ...
            {position.isActive ? (
              <Badge
                variant='outline'
                className='mt-1 py-0 h-5 bg-green-500/10 text-green-600 border-green-500/20 text-xs'
              >
                Active
              </Badge>
            ) : (
              <Badge
                variant='outline'
                className='mt-1 py-0 h-5 bg-red-500/10 text-red-600 border-red-500/20 text-xs'
              >
                Inactive
              </Badge>
            )}
